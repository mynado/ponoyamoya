  ...
  return (
    <button
      className={clsx(
        ...
        "py-3 px-6 font-medium cursor-pointer disabled:opacity-80 disabled:cursor-not-allowed hover:opacity-90 transition-all duration-200 ease-in-out flex items-center justify-center",
        className,
      )}
      {...rest}
    >
