      ...
      {items.map((item, i) => {
        ...
        return (
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-4 md:p-5 bg-linear-to-t from-black/80 via-black/30 to-transparent lg:opacity-0 lg:group-hover:opacity-100 transition-opacity duration-500">
